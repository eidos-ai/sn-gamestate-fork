...
#### MLFlow
Please execute the following commands to make sure mlflow can get the uri of the server
    and the user that's gonna do the tracking.
```bash
...
```
You can access the server at https://track.eidos.ai/
